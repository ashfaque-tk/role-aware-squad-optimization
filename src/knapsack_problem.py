# knapsack problem from Kie Codes (YouTube)
...
# specific problem items
Thing = namedtuple('Thing',['name','value','weight'])

things = [Thing('Laptop',500,2200),Thing('Headphones',150,160),
          Thing('Coffee Mug',60,350),Thing('Notepad',40,333),
          Thing('Water Bottle',30,192)]

more_things = [Thing('Mints',5,25),Thing('Socks',10,38),
          Thing('Phone',500,200),Thing('Tissues',15,80),
...
# solution function:  select the solution pairs which will be the parents for the next
#generations, solution with higher fitness most likely be chosen
